        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h2 class="mb-0">Data Penilaian</h2>
              <div class="col-auto">
              ...
              <table class="table table-flush text-center data-table">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th style="font-size: 13px;">Nama Dosen</th>
...
@push('page-scripts')
    ...
    $(document).ready(function () {
      ...
      var table = $('.data-table').DataTable({
        ...
        serverSide: true,
        rowId:"id",
        ajax: "{{ route('penilaian_dataTable') }}",
        columns: [
      ...
      $(document).on('click', '#show',function (e) {
          ...
          $.ajax({
              type: 'get',
              url: "/penilaian/show/"+id,
              success: function(data) {
              hide_loading(element, 'eye', '', '');
              $('#modalDialogLabel').html("Show Data")
              $('#modalDialogSize').addClass("modal-lg")
              $('#modalDialogData').html(data);
              $('#modalDialog').modal({
                  backdrop: 'static'
